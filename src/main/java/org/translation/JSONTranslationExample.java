...
public class JSONTranslationExample {
    ...
    public String getCountryNameTranslation(String countryCode, String languageCode) {
        ...
        JSONObject country = jsonArray.getJSONObject(ind);
        String name = country.getString(languageCode);
        if (name != null) {
            return name;
        }
        return "Country not found";
    ...
    public static void main(String[] args) {
        ...
        String translation = jsonTranslationExample.getCountryNameTranslation("aut", "en");
